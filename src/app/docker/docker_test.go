...
func (suite *DockerTestSuite) TestInstallSoftwareInContainer_GoType() {
	pkgManager := &PackageManagerInfo{
		Manager: "apt-get",
	}
...
func (suite *DockerTestSuite) TestInstallSoftwareInContainer_InvalidType() {
	pkgManager := &PackageManagerInfo{
		Manager: "apt-get",
	}
...
// Test copyPortunixToContainer function with mocked Docker commands
func (suite *DockerTestSuite) TestCopyPortunixToContainer_MockedSuccess() {
	// Mock execInContainer to avoid actual Docker calls
	originalExec := execInContainer
	defer func() { execInContainer = originalExec }()
...
// Test runPortunixInstallInContainer function
func (suite *DockerTestSuite) TestRunPortunixInstallInContainer_Success() {
	// Mock execInContainer to avoid actual Docker calls
	originalExec := execInContainer
	defer func() { execInContainer = originalExec }()
...
func (suite *DockerTestSuite) TestRunPortunixInstallInContainer_Python() {
...
func (suite *DockerTestSuite) TestRunPortunixInstallInContainer_Default() {
	// Mock execInContainer
	originalExec := execInContainer
	defer func() { execInContainer = originalExec }()
...
func (suite *DockerTestSuite) TestRunPortunixInstallInContainer_ExecError() {
