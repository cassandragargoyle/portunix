...
The `container` command is the **universal container interface** that automatically detects and uses
the best available container runtime (Docker or Podman) on your system. It provides a consistent
API across all container platforms.
